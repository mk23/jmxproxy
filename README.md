...
- Latest version compiled artifact: [jmxproxy-3.1.1.jar](https://github.com/mk23/jmxproxy/releases/download/jmxproxy.3.1.1/jmxproxy-3.1.1.jar)
- Latest version source code archive: [jmxproxy.3.1.1.tar.gz](https://github.com/mk23/jmxproxy/archive/jmxproxy.3.1.1.tar.gz)
...
The resulting package is a self-executable "fat jar" file located at `target/jmxproxy-3.1.1.jar`.
...
The self-executing fat jar file contains all the bits necessary to start and run the server.
    ...
    $ java -jar target/jmxproxy-3.1.1.jar server
...
A more complex example that enables the [JMX](http://docs.oracle.com/javase/7/docs/technotes/guides/management/agent.html) agent and limits heap may look something like this:
    ...
    $ java -Xmx100m -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.port=1123 -jar target/jmxproxy-3.1.1.jar server
